...
| [`Perceptron, Gradient Descent Backpropagation in PyTorch/`](./Perceptron_gradient_backpropagation.ipynb) | Perceptron| Gradient Descent| Backpropagation |Logic Gate|
